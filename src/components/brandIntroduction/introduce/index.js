...
export default class introduce extends Component {
    state = {
        list: [
            { subtitle: "办学规模", title: "强大的办学规模", text: '已开设<span class="color">18</span>家直营校区 （北京<span class="color">16</span>家，上海<span class="color">2</span>家） 总教学面积近<span class="color">35000</span>平米', img: picture1 },
