...
export default class curriculumPlanComponent extends Component {
  state = {
    data: [
      {
        id: 1,
        img: require("../../../assets/brandIntroduction/course/class1.png")
          .default,
        text: [
      ...
      {
        id: 2,
        img: require("../../../assets/brandIntroduction/course/class2.png")
          .default,
        text: [
      ...
      {
        id: 3,
        img: require("../../../assets/brandIntroduction/course/class3.png")
          .default,
        text: [
  ...
  retrievalNode = () => {
    ...
    return data.map((item) => {
      if (item.type === "left") {
        return (
          <div className="imgText" key={item.id}>
            <div className="image">
