...
export default class jazzGrading extends Component {
    state = {
        componentJson: [
            {
                component: 'Banner',
                props: {
                    bannerList: [
                        { id: 1, adress: "/artGrading/artExamDance/latinGrading", src: require("../../../assets/artGrading/artExamDance/jazz/banner.jpg").default },
                    ]
                }
            },
            {
                ...
                props: {
                    navList: [
                        { img: require('../../../assets/artGrading/artExamDance/jazz/nav1.jpg').default, text: "艺考爵士舞1V1", href: "service" },
    ...
    render() {
        ...
        return (
            <div>
                {
                    seekComponents(componentJson, 'jazzGrading')
                }
            </div>
        )
    }
