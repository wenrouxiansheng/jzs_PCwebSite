...
export default class drumKitGrading extends Component {
    state = {
        componentJson: [
            {
                ...
                props: {
                    navList: [
                        { img: require('../../../assets/instrumentalMusic/nav5.jpg').default, text: "艺考架子鼓冲刺1V1", href: "service" },
    ...
    render() {
        ...
        return (
            <div>
                {
                    seekComponents(componentJson, 'drumKitGrading')
                }
            </div>
        )
    }
