...
export default class pianoGrading extends Component {
    state = {
        componentJson: [
            {
                component: 'Banner',
                props: {
                    bannerList: [
                        { id: 1, adress: "#", src: require("../../../assets/artGrading/artExamIM/piano/banner.jpg").default },
                    ]
                }
            },
            {
                ...
                props: {
                    navList: [
                        { img: require('../../../assets/instrumentalMusic/nav4.jpg').default, text: "艺考钢琴冲刺1V1", href: "service" },
    ...
    render() {
        ...
        return (
            <div>
                {
                    seekComponents(componentJson, 'pianoGrading')
                }
            </div>
        )
    }
