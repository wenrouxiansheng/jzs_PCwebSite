...
export default class belCantoGrading extends Component {
    state = {
        componentJson: [
            {
                component: 'Banner',
                props: {
                    bannerList: [
                        { id: 1, adress: "#", src: require("../../../assets/artGrading/artExamMusic/belCanto/banner.jpg").default },
                    ]
                }
            },
            {
                ...
                props: {
                    navList: [
                        { img: require('../../../assets/artGrading/artExamMusic/belCanto/nav1.jpg').default, text: "艺考美声1V1", href: "service" },
                        ...
                        { img: require('../../../assets/artGrading/artExamMusic/pop/nav6.jpg').default, text: "艺考声乐考试模拟班", href: "service" },
                    ]
                }
            },
    ...
    render() {
        ...
        return (
            <div>
                {
                    seekComponents(componentJson, 'belCantoGrading')
                }
            </div>
        )
    }
