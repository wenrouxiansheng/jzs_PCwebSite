...
export default class popMusicGrading extends Component {
    state = {
        componentJson: [
            {
                component: 'Banner',
                props: {
                    bannerList: [
                        { id: 1, adress: "#", src: require("../../../assets/artGrading/artExamMusic/pop/banner.jpg").default },
                    ]
                }
            },
            {
                ...
                props: {
                    navList: [
                        { img: require('../../../assets/artGrading/artExamMusic/pop/nav1.jpg').default, text: "艺考流行冲刺1V1", href: "service" },
    ...
    render() {
        ...
        return (
            <div>
                {
                    seekComponents(componentJson, 'popMusicGrading')
                }
            </div>
        )
    }
