...
export default class childClassical extends Component {
    state = {
        componentJson: [
            {
                ...
                props: {
                    introduction: {
                        img: require('../../../../assets/danceTraining/classical/child/show.jpg').default,
                        subTitle: "古典舞",
                        title: "古典舞介绍",
                        text: "具有一定典范意义的和古典风格特点的舞蹈。学习古典舞可以对音乐有更深刻的认识，提升舞感，乐感节奏感及模仿力。体现自身优势，培养意志力，敢于展示自我善于表演，更自信，从众人群中脱颖而出。"
                    }
                }
            },
            {
    ...
    render() {
        ...
        return (
            <div>
                {
                    seekComponents(componentJson, 'childClassical')
                }
            </div>
        )
    }
