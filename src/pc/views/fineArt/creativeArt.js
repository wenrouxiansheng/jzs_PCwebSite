...
export default class creativeArt extends Component {
        ...
        componentJson: [
            {
                ...
                props: {
                    bannerList: [
                        { id: 1, adress: "/", src: require("../../assets/fineArt/creativeArt/banner.jpg").default },
                    ]
                }
            },
            {
                ...
                props: {
                    navList: [
                        { img: require('../../assets/fineArt/nav7.jpg').default, text: "创意美术", href: "#" },
                        { img: require('../../assets/fineArt/child/nav1.jpg').default, text: "少儿美术", href: "/site/pc/fineArt/children" },
                    ]
                }
            },
            {
    ...
    render() {
        ...
        return (
            <div>
                {
                    seekComponents(componentJson, 'creativeArt')
                }
            </div>
        )
    }
