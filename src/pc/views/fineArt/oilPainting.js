...
export default class oilPainting extends Component {
            ...
            },
            {
                ...
                props: {
                    navList: [
                        ...
                        { img: require('../../assets/fineArt/oilPainting/nav3.jpg').default, text: "成人油画", href: "/site/pc/fineArt/oilPainting/adult" },
                    ]
                }
            },
            {
    ...
    componentDidMount() {
        document.title = '桔子树艺术-油画综合';

        if (!editingStatus.getState()) return false;
        //订阅 - 接收编辑器改变组件后的数据
        getChangeComponent = PubSub.subscribe('getChangeComponentData', (msg, data) => {
            if (data.type !== 'oilPainting') {
    ...
    render() {
        ...
        return (
            <div>
                {
                    seekComponents(componentJson, 'oilPainting')
                }
            </div>
        )
    }
