...
export default class adultGouache extends Component {
    state = {
        componentJson: [
            {
                ...
                props: {
                    introduction: {
                        img: require('../../../../assets/fineArt/nav4.jpg').default,
                        subTitle: "水粉",
                        title: "水粉介绍",
    ...
    componentDidMount() {
        document.title = '桔子树艺术-成人水粉';

        if (!editingStatus.getState()) return false;
        //订阅 - 接收编辑器改变组件后的数据
        getChangeComponent = PubSub.subscribe('getChangeComponentData', (msg, data) => {
            if (data.type !== 'adultGouache') {
    ...
    render() {
        ...
        return (
            <div>
                {
                    seekComponents(componentJson, 'adultGouache')
                }
            </div>
        )
    }
