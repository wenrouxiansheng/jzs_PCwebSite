...
export default class childOilPainting  extends Component {
        ...
        componentJson: [
            {
                ...
                props: {
                    introduction: {
                        img: require('../../../../assets/fineArt/nav3.jpg').default,
                        subTitle: "油画",
                        title: "油画介绍",
                        text: "油画颜料不透明，覆盖力强，所以绘画时可以由深到浅，逐层覆盖，使绘画产生立体感。"
                    }
                }
            },
            {
    ...
    render() {
        ...
        return (
            <div>
                {
                    seekComponents(componentJson, 'childOilPainting')
                }
            </div>
        )
    }
