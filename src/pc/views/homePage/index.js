...
import switchComponents from '@components/Summary'//汇总的组件
const stateJson = [
    {
        component: 'Banner',
        props: {
...
// window.changeHomePage = () => {
//     stateJson.bannerData[0].src = "asdasda"
//     console.log(React)
// }
export default class homePage extends Component {
    ...
    componentDidMount() {
        ...
        if (window.self !== window.top) {//判断是否被iframe嵌套 挂载监听
            ...
            window.addEventListener("message", this.changeComponentState, false);

        }

    }
    testLoop = () => {
        return stateJson.map((item, index) => {
