...
export default class adultDrumKit extends Component {
        ...
        componentJson: [
            {
                ...
                props: {
                    introduction: {
                        img: require('../../../../assets/instrumentalMusic/adult/nav3.jpg').default,
                        subTitle: "架子鼓",
                        title: "架子鼓介绍",
    ...
    render() {
        ...
        return (
            <div>
                {
                    seekComponents(componentJson, 'adultDrumKit')
                }
            </div>
        )
    }
