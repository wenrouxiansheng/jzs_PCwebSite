...
export default class childUkulele extends Component {
        ...
        componentJson: [
            {
                ...
                props: {
                    introduction: {
                        img: require('../../../../assets/instrumentalMusic/child/nav4.jpg').default,
                        subTitle: "尤克里里",
                        title: "尤克里里介绍",
    ...
    render() {
        ...
        return (
            <div>
                {
                    seekComponents(componentJson, 'childUkulele')
                }
            </div>
        )
    }
