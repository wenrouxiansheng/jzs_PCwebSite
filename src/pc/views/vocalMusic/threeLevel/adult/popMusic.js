...
export default class popMusic extends Component {
    state = {
        componentJson: [
            {
                component: 'Banner',
                props: {
                    bannerList: [
                        { id: 1, adress: "/", src: require("../../../../assets/music/popMusic/banner.jpg").default },
                    ]
                }
            },
            {
                ...
                props: {
                    introduction: {
                        img: require('../../../../assets/music/nav5.jpg').default,
                        subTitle: "流行唱法",
                        title: "流行唱法",
    ...
    render() {
        ...
        return (
            <div>
                {
                    seekComponents(componentJson, 'popMusic')
                }
            </div>
        )
    }
