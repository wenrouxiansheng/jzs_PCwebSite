    ...
    state = {
        componentsJson: [
            ...
            },
            {
                ...
                props: {
                    data: [
                        { address: "/site/wap/beijing/fineArts/chinese/child", text: "少儿国画", img: require('../../../assets/finieArts/chinese/nav1.png').default },
                        { address: "/site/wap/beijing/fineArts/chinese/adult", text: "成人国画", img: require('../../../assets/finieArts/chinese/nav2.png').default },
                    ],
                    style: {
                        borderBottom: '0px'
                    }
