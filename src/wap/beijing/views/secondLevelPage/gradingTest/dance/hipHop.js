...
export default class hipHopGradingTest extends Component {
    state = {
        componentsJson: [
            {
                component: 'DrawerNav',
            ...
            },
            {
                ...
                props: {
                    data: {
                        list: [
                            { img: require('../../../../assets/gradingTest/dance/hipHop/banner.jpg').default, address: "#" }
                        ],
                        type: 'default'
                    }
                }
            },
            {
                ...
                props: {
                    data: [
                        { address: "service", text: "艺考街舞<br>1V1", img: require('../../../../assets/gradingTest/dance/hipHop/nav1.png').default },
                        { address: "service", text: "艺考舞蹈考<br>试模拟班", img: require('../../../../assets/gradingTest/dance/hipHop/nav2.png').default },
                    ],
                    style: {
                        borderBottom: '0px'
                    }
            ...
            },
            {
                ...
                props: {
                    data: {
                        title: ['课程', '人数', '上课时长', '咨询'],
                        body: [
                            ['艺考街舞1V1', '1人', '60分钟', '<span style="color:#FF8000" class="btnsh_udesk_im">咨询详情</span>'],
