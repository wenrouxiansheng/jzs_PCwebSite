    ...
    state = {
        componentsJson: [
            ...
            },
            {
                ...
                props: {
                    data: [
                        { address: "/site/wap/beijing/danceGradingTest/folk", text: "民族舞", img: require('../../../assets/dance/nav1.png').default },
                        { address: "/site/wap/beijing/danceGradingTest/jazz", text: "爵士舞", img: require('../../../assets/dance/nav2.png').default },
                        { address: "/site/wap/beijing/danceGradingTest/modern", text: "现代舞", img: require('../../../assets/dance/nav7.png').default },
                        { address: "/site/wap/beijing/danceGradingTest/ballet", text: "芭蕾舞", img: require('../../../assets/dance/nav4.png').default },
                        { address: "/site/wap/beijing/danceGradingTest/hipHop", text: "街舞", img: require('../../../assets/dance/nav5.png').default },
                        { address: "/site/wap/beijing/danceGradingTest/latin", text: "国标舞", img: require('../../../assets/dance/nav3.png').default },
                        { address: "/site/wap/beijing/danceGradingTest/classical", text: "古典舞", img: require('../../../assets/dance/nav6.png').default },
                    ],
                    style: {
                        borderBottom: '0px'
                    }
            ...
            },
            {
                ...
                props: {
                    data: [
                        { address: "/site/wap/beijing/musicGradingTest/popMusic", text: "流行唱法", img: require('../../../assets/music/nav1.png').default },
                        { address: "/site/wap/beijing/musicGradingTest/folk", text: "民族唱法", img: require('../../../assets/music/folkSinging/nav1.png').default },
                        { address: "/site/wap/beijing/musicGradingTest/belCanto", text: "美声唱法", img: require('../../../assets/music/belCanto/nav1.png').default },
                    ],
                    style: {
                        borderBottom: '0px'
                    }
