        ...
        componentsJson: [
            ...
            },
            {
                ...
                props: {
                    data: {
                        list: [
                            { img: require('../../../assets/dance/jazz/child/banner.jpg').default, address: "#" }
                        ],
                        type: 'default'
                    }
                }
            ...
            },
            {
                ...
                props: {
                    data: {
                        title: ['课程', '教学内容', '上课时长'],
                        body: [
                            ['爵士舞集体班（4-15岁）', '基本功、能力素质与技巧培养、形体训练、爵士舞初级套路、舞蹈组合动作分解及连贯、音乐节奏训练。配合音乐完成一支成品舞或者组合', '90分钟'],
                            ['爵士舞精品班（4-15岁）', '基本手位、脚位、体能素质、肌肉控制力、灵活性、协调性能力素质与技巧培养，体态、仪态训练及提升，形体塑身强化，舞蹈组合动作分解及连贯。根据学员特点量身定制成品舞、排练及多类型音乐配合', '90分钟'],
