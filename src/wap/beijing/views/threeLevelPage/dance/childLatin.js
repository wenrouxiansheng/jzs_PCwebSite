...
export default class childLatin extends Component {
    state = {
        componentsJson: [
            {
                component: 'DrawerNav',
            ...
            },
            {
                ...
                props: {
                    data: {
                        list: [
                            { img: require('../../../assets/dance/latin/child/banner.jpg').default, address: "#" }
                        ],
                        type: 'default'
                    }
                }
            ...
            },
            {
                ...
                props: {
                    data: {
                        title: ['课程', '教学内容', '上课时长'],
                        body: [
                            ['拉丁舞集体班（4-15岁）', '基本功、能力素质与技巧培养、形体训练、原地重心移动和扭转、舞蹈组合动作分解及连贯、音乐节奏训练。配合音乐完成一支成品舞或者组合', '90分钟'],
                            ['拉丁舞精品班（4-15岁）', '基本手位、脚位、体能素质、肌肉控制力、灵活性、协调性。能力素质与技巧培养，体态、仪态训练及提升。原地重心移动和扭转，原地重心移动和扭转，手中转步、连续扭臀转步、滑门步等拉丁步伐形体塑身强化，舞蹈组合动作分解及连贯。根据学员特点量身定制成品舞、排练及多类型音乐配合', '90分钟'],
