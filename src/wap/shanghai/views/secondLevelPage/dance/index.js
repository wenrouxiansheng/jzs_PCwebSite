        ...
        componentsJson: [
            ...
            },
            {
                ...
                props: {
                    data: {
                        list: [
                            { img: require('../../../assets/dance/banner.png').default, address: "#" }
                        ],
                        type: 'default'
                    }
                }
            },
            {
                ...
                props: {
                    data: [
                        { address: "/site/wap/shanghai/dance/folkDance", text: "民族舞", img: require('../../../assets/dance/nav1.png').default },
                        { address: "/site/wap/shanghai/dance/jazz", text: "爵士舞", img: require('../../../assets/dance/nav2.png').default },
                        { address: "/site/wap/shanghai/dance/latinDance", text: "拉丁舞", img: require('../../../assets/dance/nav3.png').default },
                        { address: "/site/wap/shanghai/dance/ballet", text: "芭蕾舞", img: require('../../../assets/dance/nav4.png').default },
                        { address: "/site/wap/shanghai/dance/hiphop", text: "街舞", img: require('../../../assets/dance/nav5.png').default },
                        { address: "/site/wap/shanghai/dance/chineseDance", text: "中国舞", img: require('../../../assets/dance/nav6.png').default },
                        { address: "/site/wap/shanghai/dance/classicalDance", text: "古典舞", img: require('../../../assets/dance/nav7.png').default },
                    ],
                    style: {
                        borderBottom: '0px'
                    }
