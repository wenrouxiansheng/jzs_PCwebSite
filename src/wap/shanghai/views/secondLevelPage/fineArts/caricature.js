...
export default class caricature extends Component {
    state = {
        componentsJson: [
            {
                component: 'DrawerNav',
            ...
            },
            {
                ...
                props: {
                    data: {
                        list: [
                            { img: require('../../../assets/finieArts/caricature/banner.jpg').default, address: "#" }
                        ],
                        type: 'default'
                    }
                }
            },
            {
                ...
                props: {
                    data: [
                        { address: "/site/wap/shanghai/fineArts/caricature/child", text: "少儿漫画", img: require('../../../assets/finieArts/caricature/nav1.png').default },
                        { address: "/site/wap/shanghai/fineArts/caricature/adult", text: "成人漫画", img: require('../../../assets/finieArts/caricature/nav2.png').default },
                    ],
                    style: {
                        borderBottom: '0px'
                    }
