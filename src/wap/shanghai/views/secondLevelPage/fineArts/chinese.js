        ...
        componentsJson: [
            ...
            },
            {
                ...
                props: {
                    data: {
                        list: [
                            { img: require('../../../assets/finieArts/chinese/banner.jpg').default, address: "#" }
                        ],
                        type: 'default'
                    }
                }
            },
            {
                ...
                props: {
                    data: [
                        { address: "/site/wap/shanghai/fineArts/chinese/child", text: "少儿国画", img: require('../../../assets/finieArts/chinese/nav1.png').default },
                        { address: "/site/wap/shanghai/fineArts/chinese/adult", text: "成人国画", img: require('../../../assets/finieArts/chinese/nav2.png').default },
                    ],
                    style: {
                        borderBottom: '0px'
                    }
