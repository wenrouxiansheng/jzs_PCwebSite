...
export default class pencilSketch extends Component {
    state = {
        componentsJson: [
            {
                component: 'DrawerNav',
            ...
            },
            {
                ...
                props: {
                    data: {
                        list: [
                            { img: require('../../../assets/finieArts/pencilSketch/banner.jpg').default, address: "#" }
                        ],
                        type: 'default'
                    }
                }
            },
            {
                ...
                props: {
                    data: [
                        { address: "/site/wap/shanghai/fineArts/pencilSketch/child", text: "少儿素描", img: require('../../../assets/finieArts/pencilSketch/nav1.png').default },
                        { address: "/site/wap/shanghai/fineArts/pencilSketch/adult", text: "成人素描", img: require('../../../assets/finieArts/pencilSketch/nav2.png').default },
                    ],
                    style: {
                        borderBottom: '0px'
                    }
