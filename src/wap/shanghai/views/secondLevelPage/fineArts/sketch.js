    ...
    state = {
        componentsJson: [
            ...
            },
            {
                ...
                props: {
                    data: [
                        { address: "/site/wap/shanghai/fineArts/sketch/child", text: "少儿速写", img: require('../../../assets/finieArts/sketch/nav1.png').default },
                        { address: "/site/wap/shanghai/fineArts/sketch/adult", text: "成人速写", img: require('../../../assets/finieArts/sketch/nav2.png').default },
                    ],
                    style: {
                        borderBottom: '0px'
                    }
