    ...
    state = {
        componentsJson: [
            ...
            },
            {
                ...
                props: {
                    data: [
                        { address: "/site/wap/shanghai/IMGradingTest/child", text: "少儿器乐<br>考级1V1", img: require('../../../assets/gradingTest/IM/nav1.png').default },
                        { address: "/site/wap/shanghai/IMGradingTest/child", text: "少儿器乐考<br>级精品小班", img: require('../../../assets/gradingTest/IM/nav2.png').default },
                        { address: "/site/wap/shanghai/IMGradingTest/adult", text: "成人器乐<br>考级1V1", img: require('../../../assets/gradingTest/IM/nav3.png').default },
                        { address: "/site/wap/shanghai/IMGradingTest/adult", text: "成人器乐考<br>级精品小班", img: require('../../../assets/gradingTest/IM/nav4.png').default },
                    ],
                    style: {
                        borderBottom: '0px'
                    }
