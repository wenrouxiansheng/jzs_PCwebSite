    ...
    state = {
        componentsJson: [
            ...
            },
            {
                ...
                props: {
                    data: [
                        { address: "/site/wap/shanghai/IM/drumKit/child", text: "少儿架子鼓", img: require('../../../assets/instrumentalMusic/drumKit/nav1.png').default },
                        { address: "/site/wap/shanghai/IM/drumKit/adult", text: "成人架子鼓", img: require('../../../assets/instrumentalMusic/drumKit/nav2.png').default },
                    ],
                    style: {
                        borderBottom: '0px'
                    }
