    ...
    state = {
        componentsJson: [
            ...
            },
            {
                ...
                props: {
                    data: [
                        { address: "/site/wap/shanghai/IM/piano/child", text: "少儿钢琴", img: require('../../../assets/instrumentalMusic/piano/nav1.png').default },
                        { address: "/site/wap/shanghai/IM/piano/adult", text: "成人钢琴", img: require('../../../assets/instrumentalMusic/piano/nav2.png').default },
                    ],
                    style: {
                        borderBottom: '0px'
                    }
