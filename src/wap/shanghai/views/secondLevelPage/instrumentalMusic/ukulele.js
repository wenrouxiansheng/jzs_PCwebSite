    ...
    state = {
        componentsJson: [
            ...
            },
            {
                ...
                props: {
                    data: [
                        { address: "/site/wap/shanghai/IM/ukulele/child", text: "少儿尤克里里", img: require('../../../assets/instrumentalMusic/ukulele/nav1.png').default },
                        { address: "/site/wap/shanghai/IM/ukulele/adult", text: "成人尤克里里", img: require('../../../assets/instrumentalMusic/ukulele/nav2.png').default },
                    ],
                    style: {
                        borderBottom: '0px'
                    }
