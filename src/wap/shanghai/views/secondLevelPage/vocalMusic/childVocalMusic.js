        ...
        componentsJson: [
            ...
            },
            {
                ...
                props: {
                    data: {
                        list: [
                            { img: require('../../../assets/music/child/banner.png').default, address: "#" }
                        ],
                        type: 'default'
                    }
                }
            },
            {
                ...
                props: {
                    data: [
                        { address: "/site/wap/shanghai/music/solfeggio", text: "少儿视唱练耳", img: require('../../../assets/music/child/nav1.png').default },
                        { address: "/site/wap/shanghai/music/soundBase", text: "少儿音基培训", img: require('../../../assets/music/child/nav2.png').default },
                        { address: "/site/wap/shanghai/music/musicMaster", text: "少儿音乐培训", img: require('../../../assets/music/child/nav3.png').default },
                        { address: "/site/wap/shanghai/music/soundBase", text: "少儿基础乐理", img: require('../../../assets/music/child/nav4.png').default },
                    ],
                    style: {
                        borderBottom: '0px'
                    }
