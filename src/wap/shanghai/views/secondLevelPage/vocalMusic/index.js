    ...
    state = {
        componentsJson: [
            ...
            },
            {
                ...
                props: {
                    data: [
                        { address: "/site/wap/shanghai/music/adult", text: "成人声乐", img: require('../../../assets/music/nav1.png').default },
                        { address: "/site/wap/shanghai/music/child", text: "少儿声乐", img: require('../../../assets/music/nav2.png').default },
                        { address: "/site/wap/shanghai/music/childrenVoice", text: "童声", img: require('../../../assets/music/nav3.png').default },
                        { address: "/site/wap/shanghai/music/karaokeTraining", text: "K歌速成", img: require('../../../assets/music/nav4.png').default },
                        { address: "/site/wap/shanghai/music/popularSinging", text: "流行唱法", img: require('../../../assets/music/nav5.png').default },
                        { address: "/site/wap/shanghai/music/soundBase", text: "音基培训", img: require('../../../assets/music/nav6.png').default },
                        { address: "/site/wap/shanghai/music/solfeggio", text: "视唱练耳", img: require('../../../assets/music/nav7.png').default },
                    ],
                    style: {
                        borderBottom: '0px'
                    }
