...
export default class adultClassical extends Component {
    state = {
        componentsJson: [
            {
                component: 'DrawerNav',
            ...
            },
            {
                ...
                props: {
                    data: {
                        list: [
                            { img: require('../../../assets/dance/classicalDance/adult/banner.jpg').default, address: "#" }
                        ],
                        type: 'default'
                    }
                }
            ...
            },
            {
                ...
                props: {
                    data: {
                        title: ['课程', '教学内容', '上课时长'],
                        body: [
                            ['古典舞集体班（16-80岁）', '基本功、能力素质与技巧培养、形体训练、舞蹈组合动作分解及连贯、音乐节奏训练。配合音乐完成一支成品舞或者组合', '90分钟'],
                            ['古典舞精品班（16-80岁）', '基本手型、手位、脚位、柔韧度练习及强化、能力素质与技巧培养，体态、仪态训练及提升，形体塑身强化，舞蹈组合动作分解及连贯。根据学员特点量身定制成品舞、排练及音乐配合', '90分钟'],
                        ]
                    }
                }
            },
