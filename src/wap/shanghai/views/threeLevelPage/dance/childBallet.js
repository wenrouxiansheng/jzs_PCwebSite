        ...
        componentsJson: [
            ...
            },
            {
                ...
                props: {
                    data: {
                        list: [
                            { img: require('../../../assets/dance/ballet/child/banner.jpg').default, address: "#" }
                        ],
                        type: 'default'
                    }
                }
            ...
            },
            {
                ...
                props: {
                    data: {
                        title: ['课程', '教学内容', '上课时长'],
                        body: [
                            ['芭蕾舞集体班（4-15岁）', '基本功、能力素质与技巧培养、形体训练、灵活性、协调性，软度训练。基本功强化。舞蹈组合动作分解及连贯。配合音乐完成一支成品舞或者组合', '90分钟'],
                            ['芭蕾舞精品班（4-15岁）', '形体训练、体能训练（软度、力度、平衡、重心、协调性、速度灵巧性及每一关节、每块肌肉和每条韧带进行的训练）。能力素质与技巧培养，体态、仪态训练及提升，形体塑身强化，舞蹈组合动作分解及连贯。根据学员特点量身定制成品舞、排练及多类型音乐配合', '90分钟'],
