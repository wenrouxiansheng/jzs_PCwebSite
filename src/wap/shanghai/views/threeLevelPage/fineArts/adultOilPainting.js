...
export default class adultOilPainting extends Component {
    state = {
        componentsJson: [
            {
                component: 'DrawerNav',
            ...
            },
            {
                ...
                props: {
                    data: {
                        list: [
                            { img: require('../../../assets/finieArts/adultOilPainting/banner.jpg').default, address: "#" }
                        ],
                        type: 'default'
                    }
                }
